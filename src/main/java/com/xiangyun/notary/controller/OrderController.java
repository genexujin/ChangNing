...
public class OrderController {
	...
	public ModelAndView goToStep3(HttpServletRequest request,
		...
		for (FormDef formDef : selectedForms) {
			...
			if (formDef.getFormKey().equals("CS")
					|| formDef.getFormKey().equals("CSZFYJ")) {
				request.setAttribute("Special_note", "如本人和父母不在同一本户口本，请分别上传");
			}
	...
	private FeeItem createGeneralFeeItem(Order order, FormDef formDef,
			FeeDef feeDef) {
