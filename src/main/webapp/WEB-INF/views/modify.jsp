...
<script type="text/javascript">
	$(function() {
		...
		$("#modify_user_address").blur(
				function() {
					if ($("#modify_user_address").val().length == 0) {
						$("#modify_address_alert").removeClass().addClass(
								"alert alert-error").show().html("地址不能为空！");
					} else {
						$("#modify_address_alert").removeClass().addClass(
								"alert alert-success").show().html(
								"<h7 style='font-family:幼圆'>√</h7>");
	...
	function checkModifyForm() {
		...
		if ($("#modify_user_email").val().length == 0) {
			$("#modify_email_alert").removeClass()
					.addClass("alert alert-error").show().html("邮箱不能为空！");
				...
				<div class="span12">
					<table width="98%">
						...
						<tr>
							...
							<td colspan="2"><input type="text" class="input" id="modify_user_name" placeholder="name" value="${user.name}" name="name"></td>
							<td>
								<div class="controls">
						...
						<tr>
							...
							<td colspan="3"><input type="text" class="input-xlarge" id="modify_user_cardnum" placeholder="cardnumber" name="credentialId" value="${user.credentialId}"></td>
						...
						<tr>
							...
							<td colspan="3"><input type="text" class="input-xlarge" id="modify_user_email" placeholder="email" name="email" value="${user.email}"></td>
							<td><div id="modify_email_alert" class="alert" style="display: none">请输入或修改邮箱！</div></td>
						</tr>
						<tr>
							<td><p class="text-right">联系地址：</p></td>
							<td colspan="3"><input type="text" class="input-xlarge" id="modify_user_address" placeholder="address" name="address" value="${user.address}"></td>
				...
				<div class="span12">
					<table width="98%">
						...
						<tr>
							...
							<td><input type="text" class="input-small" id="modify_user_smscode" name="modify_user_smscode" placeholder="smscode"></td>
							<td colspan="2">
	...
	<div class="span12">
		<table>
			<tr>
				...
				<td><div class="span3 offset4" >
					<button onclick="window.location.href='/ChangNing/certStep1.do'"  type="button" class="btn btn-large btn-block ">进入公证业务</button>
					</div>
				</td>
